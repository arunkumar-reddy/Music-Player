 ...
 */
public class AlbumList extends ActionBarActivity implements MediaController.MediaPlayerControl
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songView = (ListView)findViewById(R.id.textView);
        ...
        AlbumListAdapter listAdt = new AlbumListAdapter(this,songList);
        songView.setAdapter(listAdt);
        setController();
    }
    @Override
