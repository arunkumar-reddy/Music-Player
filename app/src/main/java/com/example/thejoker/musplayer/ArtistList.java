 ...
 */
public class ArtistList extends ActionBarActivity implements MediaController.MediaPlayerControl
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListAdapter listAdt = new ListAdapter(this,songList);
